...
namespace SAML.PoC.IdP.Controllers
{
    [AllowAnonymous]
    [Route("Auth")]
    public class AuthController : Controller
    {
        ...
        private static IEnumerable<Claim> CreateTestUserClaims(string selectedNameID)
        {
