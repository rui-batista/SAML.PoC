...
namespace SAML.PoC.SP1.Identity
{
    public class AppExtensions : Schemas.Extensions
    {
        private static readonly XName eidasNamespaceNameX = XNamespace.Xmlns + "eidas";
        private static readonly Uri eidasNamespace = new("http://eidas.europa.eu/saml-extensions");
        private static readonly XNamespace eidasNamespaceX = XNamespace.Get(eidasNamespace.OriginalString);
